...
MODELS = [
    ("A_simp",       "20_isaac_30t.csv", "A: PBRS single-agent",     "#0072B2",  "o"),
    ("B_curr",       "28_isaac_30t.csv", "B: PBRS + curriculum",    "#E69F00",  "s"),
    ("E_asp_dpose",  "26_isaac.csv",     "E: ASP + d\\_pose",       "#D55E00",  "D"),
    ("F_asp_disc",   "26_isaac.csv",     "F: ASP + disc",           "#CC79A7",  "v"),
    ("G_tasp_dpose", "26_isaac.csv",     "G: TASP + d\\_pose",      "#009E73",  "^"),
    ("H_tasp_disc",  "26_isaac.csv",     "H: TASP + disc",          "#56B4E9",  "P"),
]
...
def plot_per_test_errorbars(data: list[dict], out_dir: str):
    ...
    ax1.set_title("Per-Scene SR with 95% Binomial CIs — A vs B Head-to-Head\n(30 T-block scenes, best-of-20 trials each)",
                  fontweight="bold")
    ...
    ax2.set_title("Per-Scene SR — All 6 Models (95% Binomial CIs)",
                  fontweight="bold")
    ax2.set_xticks(x_t)
