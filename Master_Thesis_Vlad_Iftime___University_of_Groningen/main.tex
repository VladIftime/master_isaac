...
\title{
    \vspace{5cm}
        ...
        \vspace{2mm}Single-Agent Reward Shaping\\
        \vspace{4mm}{\Large A Regime Analysis of a Method That Succeeds Elsewhere}}
        }\\
...
\begin{center}
    ...
    \vspace{1cm}{\bf{\large Contact-Rich Planar Goal-Reaching:\\\vspace{1mm}Why Asymmetric Self-Play Underperforms Single-Agent Reward Shaping\\\vspace{1mm}\normalsize A Regime Analysis of a Method That Succeeds Elsewhere}}\\
