...
% Placeholder for results pending from the running HPC campaign.
% \TBD prints a red "TBD" token; results filled in once the campaign completes.
...
\title{
    \vspace{5cm}
        {\bf
        {\Huge Potential-Based Reward Shaping\\
        \vspace{2mm}for Planar Pushing:\\
        \vspace{4mm}Single-Agent Control vs.\ Asymmetric Self-Play}
        }\\
        \vspace{10cm}{\LARGE Vlad Iftime}
}
\date{}
...
\begin{center}
    ...
    \vspace{1cm}{\bf{\large Potential-Based Reward Shaping for Planar Pushing:\\\vspace{1mm}Single-Agent Control vs.\ Asymmetric Self-Play}}\\
