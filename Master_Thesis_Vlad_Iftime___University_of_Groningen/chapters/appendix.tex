...
\oldresults{single-seed per-scene bars and the "statistically equivalent" claim;
to be regenerated with the seed-CI data.}
...
\oldresults{the 0\% collapse is an old single-seed observation; the Bob-penalty
phase of the experiment set will quantify it with confidence intervals.}
...
\oldresults{the "10-percentage-point" advantage is an old number, and the new
single-axis isolations (disc, ABC on/off, encoder on/off) change this account.}
...
\oldresults{old single-seed 80.0\% figures and the "five principal models" framing.}
...
\oldresults{treats disc and Bob-penalty as "secondary" and cites old results;
these are now first-class subjects in the experiment set.}
