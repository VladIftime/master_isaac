...
within the literature. It begins with the formal definitions of
...
thesis works entirely in the model-free, on-policy setup and asks a
...
\cite{Narvekar2020} provides a taxonomy that distinguishes, among other dimensions,
...
require. This is a difference in setup, not a defect in the earlier work, and it
defines one of the dimensions along which this thesis explains why a proven method
underperforms here.
