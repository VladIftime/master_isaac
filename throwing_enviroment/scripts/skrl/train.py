#!/usr/bin/env python3
"""Train an RL agent for throwing with skrl.
...
parser.add_argument("--playing_arm_side", type=str, default="right", help="Which arm throws: left or right.")
...
import Throwing.tasks  # noqa: F401 — registers Throwing-Direct-v0
