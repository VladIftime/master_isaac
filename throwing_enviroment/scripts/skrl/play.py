...
parser.add_argument(
    "--task", type=str, default="Throwing-Direct-v0", help="Name of the task."
)
parser.add_argument(
...
parser.add_argument(
    "--algorithm", type=str, default="PPO", choices=["PPO", "IPPO", "MAPPO"]
)
...
def main(
    ...
    while simulation_app.is_running():
        with torch.no_grad():
            actions = runner.agent.running_models["policy"].act(
                obs["states"], timestep=0, timesteps=1
            )
