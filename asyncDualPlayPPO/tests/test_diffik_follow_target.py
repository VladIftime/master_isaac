"""
DiffIK Interactive Follow-Target Test (IsaacLab)
=================================================

Spawns a red visual sphere at the gripper midpoint that you can move with
the viewport gizmo. Differential Inverse Kinematics (DiffIK) computes the
control commands in real-time.

Usage:
    python tests/test_diffik_follow_target.py --max_vel 0.5
...
def main():
    parser = argparse.ArgumentParser(description="DiffIK Interactive Follow Target")
