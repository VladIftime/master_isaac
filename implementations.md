...
**Last updated**: 2026-07-12 (smoke-test campaign passed: manifest/dry-runs, single-agent train+resume, self-play checkpoints, disc subspace; gym `gym_pusht` fork installed; V100 found cu128-incompatible; measured resource sizing — §2 timeline)
