...
**Last updated**: 2026-07-12 (§14 job-array campaign + ABC macro-action repair; full resume/checkpoint integrity chain; ASP-failure thesis refocus: validator sampling, canonical ABC-on, `--no_ge` on G, gradient-update logging, gym-C `--push_nsteps`, re-scoped 94+10 matrix per thesis_plan.md §2.1)
