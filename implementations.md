...
**Last updated**: 2026-05-28 (Fixes P39–P47: push obs 29→28D, waypoint loop death, exploded state, zero penalty, dynamic minibatches, elbow-IK no-terminate, zero-length push, completion termination, rotation rebalance)
