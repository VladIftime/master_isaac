...
**Last updated**: 2026-07-12 (§14 train_h paths+guard fixed; ppo.load dim-mismatch warning; validation --argmax; gradient-update full coverage; orphan params cleaned)
