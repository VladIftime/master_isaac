...
class UR5ePickPlace(tasks.PickPlace):
    ...
    def get_params(self) -> dict:
        ...
        params_representation[f"task_object_position_0"] = {
            "value": self.position,
            "modifiable": True,
        }
        params_representation[f"task_object_orientation_0"] = {
            "value": self.orientation,
            "modifiable": True,
        }
        params_representation[f"task_object_name_0"] = {
            "value": self.task_object_name,
            "modifiable": False,
        }
