...
```
\begin{array}{l} \textbf{for iteration}{=}1,2,\ldots\,\textbf{do} \\ \textbf{for actor}{=}1,2,\ldots,N\,\,\textbf{do} \\ \textbf{Run policy}\,\,\pi_{\theta_{\text{old}}}\,\,\text{in environment for}\,\,T\,\,\text{timesteps} \\ \textbf{Compute advantage estimates}\,\,\hat{A}_1,\ldots,\hat{A}_T\\ \textbf{end for} \\ \textbf{Optimize surrogate}\,\,L\,\,\text{wrt}\,\,\theta,\,\,\text{with}\,\,K\,\,\text{epochs and minibatch size}\,\,M\leq NT\\ \theta_{\text{old}}\leftarrow\theta \\ \textbf{end for} \\ \end{array}
```
