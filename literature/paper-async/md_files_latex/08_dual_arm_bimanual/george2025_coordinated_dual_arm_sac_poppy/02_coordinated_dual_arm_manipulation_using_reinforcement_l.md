...
Abhishek Sarkar *Dept. of Mechanical Engg. BITS Pilani* Hyderabad, India abhisheks@hyderabad.bits-pilani.ac.in
...
Fig. 3: Loss vs Training step graph.
 ...
 $\|p_{\text{com}} - p_{\text{goal}}\|_2$ , is less than 0.03; both palms are within a threshold distance of 0.4 from  $p_{\text{com}}$ ; and the inter-palm distance,  $d_{\text{palm}}$ , is greater than 0.05. Under these conditions, a bonus reward of +10 is assigned, and the episode is marked as successful.
