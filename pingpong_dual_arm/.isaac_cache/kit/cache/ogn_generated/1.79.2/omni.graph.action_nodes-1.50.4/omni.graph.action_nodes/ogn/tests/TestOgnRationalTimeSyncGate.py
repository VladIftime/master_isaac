...
class TestOgn(ogts.OmniGraphTestCase):
    ...
    async def test_data_access(self):
        ...
        test_node = og.Controller.node(
            "/TestGraph/Template_omni_graph_action_RationalTimeSyncGate"
        )
        ...
        self.assertTrue(
            test_node.get_attribute_exists("inputs:rationalTimeDenominator")
        )
        ...
        self.assertTrue(
            test_node.get_attribute_exists("outputs:rationalTimeDenominator")
        )
